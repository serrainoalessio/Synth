COMPILE_CMD="avr-gcc -O2 -mmcu=atmega328p -Wall -o ./piano.out ./piano.c"
GENHEX_CMD="avr-objcopy -O ihex -R .eeprom piano.out piano.hex"
AVRDUDE_CMD="avrdude -C /Users/alessioserraino/Downloads/GCC-10.6/tools/avr/etc/avrdude.conf -p m328p -c stk500v1 -P /dev/tty.usbmodem641 -b 19200 -e -U flash:w:./piano.hex"
